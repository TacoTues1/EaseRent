    ...
    return new Promise((resolve, reject) => {
        ...
        const doc = new PDFDocument({
            ...
            info: {
                ...
                Author: 'RentSphere - Rental Management System',
        ...
        // --- HEADER ---
        doc.font('Helvetica-Bold').fontSize(20).text('RentSphere - Rental Management System', { align: 'center' });
        doc.moveDown(0.5);
        ...
        doc.text('For inquiries, contact support at admin@rentsphere.com.', { align: 'center' });
