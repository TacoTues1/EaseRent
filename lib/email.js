...
export async function sendViewingApprovalEmail({
  ...
  try {
    ...
    sendSmtpEmail.sender = { name: 'RentSphere', email: 'alfnzperez@gmail.com' }
              ...
              <div style="background-color: #ffffff; max-width: 600px; width: 100%; border-radius: 16px; overflow: hidden; border: 1px solid #e5e7eb; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
                ...
                <div style="padding: 40px;">
                  ...
                  <p style="font-size: 12px; color: #9ca3af; margin-top: 32px;">
                    This is an automated notification from RentSphere. Please do not reply to this email.
                  </p>
                </div>
              </div>
            </td>
            ...
            <td align="center">
              <div style="background-color: #ffffff; max-width: 600px; width: 100%; border-radius: 16px; overflow: hidden; border: 1px solid #e5e7eb; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
                ...
                <div style="padding: 40px;">
                  ...
                  <p style="font-size: 12px; color: #9ca3af; margin-top: 32px;">
                    Please respond to this request promptly. This is an automated notification from RentSphere.
                  </p>
                </div>
              </div>
            </td>
...
export async function sendMonthlyStatementEmail({ to, tenantName, period, pdfBuffer }) {
  ...
  const htmlContent = `
    <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333;">
      ...
      <p>For inquiries and comments, please contact our Customer Support Hotline at (+632) 1111-1111 (Domestic toll-free: 1-800-1111-1111) or *1111 using your Smart mobile phone or access our built in messaging system on the RentSphere Website.</p>
      
      <p style="margin-top: 32px; font-weight: bold;">RentSphere - Rental Management System</p>
    </div>
  `
