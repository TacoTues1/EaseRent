                           ...
                           <div>
                             <label className="flex items-start gap-2 cursor-pointer group">
                                ...
                                <span className="text-[10px] text-gray-500 leading-snug">
                                  I agree to <Link href={`/terms?propertyId=${property.id}`} target="_blank" className="text-black font-bold underline">Terms</Link>.
                                </span>
                             </label>
                           </div>
                  ...
                  <div className="flex flex-col gap-2.5">
                     ...
                     {property.location_link && (
                        <div className="flex items-center gap-2">
                           ...
                           <a href={property.location_link} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 font-medium transition-colors cursor-pointer">View Map</a>
                        </div>
                     )}
                  </div>
               </div>
