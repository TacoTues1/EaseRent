                  ...
                  {(booking.status === 'pending' || booking.status === 'pending_approval') && (
                    <div className="flex flex-col sm:flex-row gap-2">
                      <button
                        ...
                        className="flex-1 px-3 py-1.5 bg-green-600 text-white hover:bg-green-700 font-medium text-xs flex items-center justify-center gap-1.5"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 px-3 py-1.5 bg-red-600 text-white hover:bg-red-700 font-medium text-xs flex items-center justify-center gap-1.5"
                      >
                        <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
